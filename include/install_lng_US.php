 ...
 * @version    $Id: install_lng_US.php,v 1.85.2.6 2011/04/14 11:34:35 aim Exp $
...
$install_languages["US"] = array (
    ...
    "install_mysql_min_version" => "MySQL v4.0.18 or later is required for X-Cart to work properly (versions
    4.1.0, 4.1.1, 5.0.50 and 5.0.51 are not recommended due to known bugs).",
