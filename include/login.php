...
if ($REQUEST_METHOD == 'POST') {
    ...
    if ($mode == 'login') {
        ...
        if ($allow_login) {
            ...
            if (!empty($active_modules['Remember_Me']) && isset($_POST['autologin']) && $auth_cookie_allowed) {
                
                func_set_auth_cookie($user_data['id'], $user_data['password']);
...
if ($mode == 'logout') {
    ...
    if (!empty($active_modules['Remember_Me']) && $auth_cookie_allowed) {
