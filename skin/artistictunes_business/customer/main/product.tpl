...
//]]>
  ...
  {/capture}
  {include file="customer/dialog.tpl" title=$product.producttitle content=$smarty.capture.dialog noborder=true additional_class_content="clear-background-border" additional_class="clear-background-border" additional_class_title="clear-background-border"}
