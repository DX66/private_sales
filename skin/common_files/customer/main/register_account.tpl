{*
$Id: register_account.tpl,v 1.3 2010/08/04 10:09:04 joy Exp $
  ...
  {if $config.email_as_login ne 'Y'}
    <tr>
      ...
      {else}
        <td class="data-required">*</td>
        <td>
          <input type="text" id="uname" name="uname" class="input-required" size="32" maxlength="32" value="{if $userinfo.uname}{$userinfo.uname|escape}{else}{$userinfo.login|escape}{/if}" />
      {/if}
      </td>
    </tr>
  {/if}
