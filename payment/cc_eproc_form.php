 ...
 * @version    $Id: cc_eproc_form.php,v 1.13.2.1 2011/01/10 13:12:06 ferz Exp $
...
if ($REQUEST_METHOD == 'POST' && !empty($_POST['ID'])) {
    ...
    $return_url = $http_location.'/payment/'.$module_params['processor'];
    $logo_url = $http_location.$smarty_skin_dir.'/images/xlogo.gif';
